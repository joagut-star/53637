...
const serializedATN = [4,1,14,52,2,0,7,0,2,1,7,1,2,2,7,2,1,0,4,0,8,8,0,11,
0,12,0,9,1,1,1,1,1,1,1,1,3,1,16,8,1,1,1,1,1,1,1,3,1,21,8,1,1,1,1,1,1,1,1,
1,3,1,27,8,1,1,1,3,1,30,8,1,1,2,1,2,1,2,1,2,1,2,1,2,1,2,3,2,39,8,2,1,2,1,
2,1,2,1,2,1,2,1,2,5,2,47,8,2,10,2,12,2,50,9,2,1,2,0,1,4,3,0,2,4,0,3,1,0,
1,2,1,0,4,5,1,0,6,7,59,0,7,1,0,0,0,2,29,1,0,0,0,4,38,1,0,0,0,6,8,3,2,1,0,
7,6,1,0,0,0,8,9,1,0,0,0,9,7,1,0,0,0,9,10,1,0,0,0,10,1,1,0,0,0,11,12,7,0,
0,0,12,15,5,9,0,0,13,14,5,8,0,0,14,16,3,4,2,0,15,13,1,0,0,0,15,16,1,0,0,
0,16,17,1,0,0,0,17,30,5,3,0,0,18,20,3,4,2,0,19,21,5,13,0,0,20,19,1,0,0,0,
20,21,1,0,0,0,21,30,1,0,0,0,22,23,5,9,0,0,23,24,5,8,0,0,24,26,3,4,2,0,25,
27,5,13,0,0,26,25,1,0,0,0,26,27,1,0,0,0,27,30,1,0,0,0,28,30,5,13,0,0,29,
11,1,0,0,0,29,18,1,0,0,0,29,22,1,0,0,0,29,28,1,0,0,0,30,3,1,0,0,0,31,32,
6,2,-1,0,32,39,5,10,0,0,33,39,5,9,0,0,34,35,5,11,0,0,35,36,3,4,2,0,36,37,
5,12,0,0,37,39,1,0,0,0,38,31,1,0,0,0,38,33,1,0,0,0,38,34,1,0,0,0,39,48,1,
0,0,0,40,41,10,5,0,0,41,42,7,1,0,0,42,47,3,4,2,6,43,44,10,4,0,0,44,45,7,
2,0,0,45,47,3,4,2,5,46,40,1,0,0,0,46,43,1,0,0,0,47,50,1,0,0,0,48,46,1,0,
0,0,48,49,1,0,0,0,49,5,1,0,0,0,50,48,1,0,0,0,8,9,15,20,26,29,38,46,48];
	...
	prog() {
	    ...
	    try {
	        ...
	        do {
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	        } while((((_la) & ~0x1f) === 0 && ((1 << _la) & 11782) !== 0));
	    } catch (re) {
...
class VarDeclContext extends StatContext {
...
CalculatorParser.VarDeclContext = VarDeclContext;
